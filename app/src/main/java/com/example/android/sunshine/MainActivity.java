...
public class MainActivity extends AppCompatActivity {
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String jsonWeatherInfo = NetworkUtils.getResponseFromHttpUrl(weatherURL);
                String[] jsonData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatherInfo);
